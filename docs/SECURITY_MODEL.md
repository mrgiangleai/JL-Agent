...
Microphone TCC. The approved personal development smoke used the
Codex-responsible Python accessor; production is reserved for the prepared
signed `com.jlagent.voice-runtime` host.
...
default. The live-verified fallback default is `hey j l`. Manual **Call JL**
remains separately gated and independent of wake.
