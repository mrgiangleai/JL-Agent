...
final class CompanionWindowController: NSObject, ObservableObject, NSWindowDelegate {
  ...
  private static let windowSize = NSSize(width: 390, height: 190)
  ...
  private func interactiveRegions() -> [CGRect] {
    var regions = [CGRect(x: 248, y: 0, width: 142, height: 190)]
    if agent.companionAnswer != nil {
      regions.append(CGRect(x: 0, y: 0, width: 248, height: 190))
    }
    return regions
  }
}
